...
<?php 
    ...
    mysql_query("DELETE FROM undangan where id_undangan='$_GET[id]'");
            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['h']['tmp_name'], $uploadfile)) {            
                         mysql_query("INSERT INTO undangan (asal_instansi, no_undangan, tempat, hari_tanggal_jam, acara, disposisi, isi_disposisi, upload_file, lokasi_arsip, waktu_eksekusi, id_user)           
                       ...
                       mysql_query("INSERT INTO undangan (asal_instansi, no_undangan, tempat, hari_tanggal_jam, acara, disposisi, isi_disposisi, lokasi_arsip, waktu_eksekusi, id_user)           
...
<?php    
    ...
    $e = mysql_fetch_array(mysql_query("SELECT * FROM undangan where id_undangan='$_GET[id]'"));
    if (isset($_POST[update])){
            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['h']['tmp_name'], $uploadfile)) {            
                         mysql_query("UPDATE undangan SET asal_instansi     = '$_POST[a]',
                                                              no_undangan       = '$_POST[b]',
                                                              tempat            = '$_POST[c]',
