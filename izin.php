                ...
                <div class="panel-body">
                 <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    <tr>
                        ...
                        <th width='100px'>Masuk Tanggal</th>
						<th width='100px'>Ijin Tanggal</th>
                        <th>Nomor Surat</th>
						<th>Jmlh Perihal</th>
                            ...
                            echo "<tr class='gradeX'>
                                    ...
                                    <td>$i[unit_kerja]</td>";
                                    	if ($_SESSION[level]=='user_admin'){ 
	                                        echo "<td style='width:170px' class='text-right'><a class='btn' href='index.php?page=izin&aksi=detail&id=$i[id_izin]' title='Lihat Detail Surat ini'><i class='fa fa-folder-open'></i></a>
	                                        	  <a class='btn' target='BLANK' href='izin-print-satu.php?id=$i[id_izin]' title='Print Surat ini'><i class='fa fa-print'></i></a>
	                                       		  <a class='btn' href='index.php?page=izin&aksi=edit&id=$i[id_izin]' title='Edit Data Surat ini'><i class='fa fa-pencil-square-o'></i></a>
	                                        	  <a class='btn' href='index.php?page=izin&aksi=hapus&id=$i[id_izin]' title='Hapus Surat ini' onclick=\"return confirm('Apakah anda Yakin Data ini Dihapus?')\" ><i class='fa fa-trash-o'></i></a>";
                						}elseif ($_SESSION[level]=='user_input'){ 
                							echo "<td style='width:90px' class='text-right'><a class='btn' href='index.php?page=izin&aksi=detail&id=$i[id_izin]' title='Lihat Detail Surat ini'><i class='fa fa-folder-open'></i></a>
	                                       		  <a class='btn' href='index.php?page=izin&aksi=edit&id=$i[id_izin]' title='Edit Data Surat ini'><i class='fa fa-pencil-square-o'></i></a>";
                						}else{
                							echo "<td style='width:50px' class='text-right'><a class='btn' href='index.php?page=izin&aksi=detail&id=$i[id_izin]' title='Lihat Detail Surat ini'><i class='fa fa-folder-open'></i></a>";
                						}
                					echo "</td>
                                 </tr>";
                            $no++;
...
<?php 
	...
	mysql_query("DELETE FROM izin where id_izin='$_GET[id]'");
            ...
            <div class="panel-heading"><strong>Tambahkan Data Surat Masuk</strong></div>
                <div class="panel-body">
                    <form action='' class="form-horizontal" method="POST" data-validate="parsley" enctype='multipart/form-data'>      
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Tanggal Ijin</label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Perihal
							</label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">hal Perihal</label>
                            <div class="col-lg-8">
                            <textarea placeholder="" name='g' rows="3" class="form-control" data-trigger="keyup"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                            <textarea placeholder="" name='h' rows="9" class="textarea form-control" data-trigger="keyup"></textarea>
                            </div>
                        </div>
...
<?php 
	...
	$e = mysql_fetch_array(mysql_query("SELECT * FROM izin where id_izin='$_GET[id]'"));
    ...
    if (isset($_POST[update])){
            ...
            $uploadfile = $dir_gambar . $filename;
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['i']['tmp_name'], $uploadfile)) {            
                        mysql_query("UPDATE izin SET asal_surat		 = '$_POST[a]',
                                                            tanggal_surat    = '$_POST[c]',
															tanggal_masuk    = '$_POST[e]',
                                                            tanggal_ijin    = '$_POST[d]',
                        									no_surat		 = '$_POST[b]',
                        									id_perihal		 = '$_POST[g]',
                        									perihal 		 = '$_POST[f]',
                                                            isi_perihal    = '$_POST[h]',
                        									file_surat 		 = '$filename',
                                                            lokasi_arsip     = '$_POST[j]' where id_izin='$_GET[id]'");
                        
                        echo "<script>window.alert('Sukses Update Data Surat Masuk.');
                                window.location='izin'</script>";
                    }else{
                        echo "<script>window.alert('Gagal Update Data Surat Masuk.');
                                window.location='index.php?page=izin&aksi=edit&id=$_GET[id]'</script>";
                    }
                }else{
                        mysql_query("UPDATE izin SET asal_surat       = '$_POST[a]',
                                                           tanggal_surat    = '$_POST[c]',
                    ...
                    <form action='' class="form-horizontal" method="POST" data-validate="parsley" enctype='multipart/form-data'>      
                        ...
                        <label class="col-lg-2 control-label">Pengirim</label>
                         ...
                         <div class="form-group">
                            <label class="col-lg-2 control-label">No Surat</label>
                            <div class="col-lg-6">
                            <input type="text" name="b" placeholder="" data-required="true" class="bg-focus form-control" value="<?php echo $e[no_surat]; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Tanggal Ijin</label>
                            <div class="col-lg-8">
                            <input type="text" class="combodate form-control" data-format="YYYY-MM-DD" data-template="D  MMM  YYYY" name="d" value="<?php echo $e[tanggal_ijin]; ?>">
                            </div>
                        </div>
						  <div class="form-group">
                            <label class="col-lg-2 control-label">Tanggal Masuk</label>
                            <div class="col-lg-8">
                            <input type="text" class="combodate form-control" data-format="YYYY-MM-DD" data-template="D  MMM  YYYY" name="e" value="<?php echo $e[tanggal_masuk]; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Perihal</label>
                            <div class="col-lg-8">
                            <textarea placeholder="" name='f' rows="3" class="form-control" data-trigger="keyup"><?php echo $e[perihal]; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Hal Perihal</label>
                            <div class="col-lg-8">
                            <textarea placeholder="" name='g' rows="3" class="form-control" data-trigger="keyup"><?php echo $e[id_perihal]; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Isi Perihal</label>
                            <div class="col-lg-8">
                            <textarea placeholder="" name='h' rows="9" class="textarea form-control" data-trigger="keyup"><?php echo $e[isi_perihal]; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Lokasi Arsip</label>
                            <div class="col-lg-6">
                            <input type="text" name="j" placeholder="" data-required="true" class="bg-focus form-control" value="<?php echo $e[lokasi_arsip]; ?>">
                            </div>
                        </div>
...
<?php            
	...
	$in = mysql_fetch_array(mysql_query("SELECT * FROM izin where id_izin='$_GET[id]'"));
                ...
                <div class='panel-body'>
                	<form action='' class='form-horizontal' data-validate='parsley' enctype='multipart/form-data'>
                        ...
                        <div class='form-group'>
                            <label class='col-lg-2 control-label'>Tanggal Masuk</label>
                            <div style='border-bottom:1px solid #e3e3e3' class='col-lg-9'>
                                ".tgl_indo($in[tanggal_masuk])."
                            </div>
                        </div>
						 <div class='form-group'>
                            <label class='col-lg-2 control-label'>Tanggal izin</label>
                            <div style='border-bottom:1px solid #e3e3e3' class='col-lg-9'>
                                ".tgl_indo($in[tanggal_ijin])."
                            </div>
                        </div>
                        ...
                        <label class='col-lg-2 control-label'>File Surat</label>
                            <div style='border-bottom:1px solid #e3e3e3' class='col-lg-9'>
                                <a href='download_izin.php?file=$in[file_surat]'>Download File Surat izin</a>
                            </div>
                        </div>
