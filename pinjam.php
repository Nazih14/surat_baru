            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['h']['tmp_name'], $uploadfile)) {            
                        mysql_query("INSERT INTO izin (asal_surat, no_surat, tanggal_surat, tanggal_masuk_agenda, id_perihal, disposisi, isi_disposisi, file_surat, lokasi_arsip, tanggal_eksekusi, id_user, unit_kerja)           
                        ...
                        mysql_query("INSERT INTO izin (asal_surat, no_surat, tanggal_surat, tanggal_masuk_agenda, id_perihal, disposisi, isi_disposisi, lokasi_arsip, tanggal_eksekusi, id_user, unit_kerja)           
                ...
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['h']['tmp_name'], $uploadfile)) {            
                        mysql_query("UPDATE izin SET asal_surat		 = '$_POST[a]',
                        									...
                        									file_surat 		 = '$filename',
                                                            lokasi_arsip     = '$_POST[i]' where id_izin='$_GET[id]'");
