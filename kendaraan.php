...
<?php 
	...
	mysql_query("DELETE FROM kendaraan where id_kendaraan='$_GET[id]'");
            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['u']['tmp_name'], $uploadfile)) {            
                        mysql_query("INSERT INTO kendaraan (jenis_kendaraan, 
                                                                  merk, 
                                                                  type, 
                                                                  nomor_polisi, 
                                                                  nomor_rangka, 
...
<?php 
	...
	$e = mysql_fetch_array(mysql_query("SELECT * FROM kendaraan where id_kendaraan='$_GET[id]'"));
    ...
    if (isset($_POST[update])){
            ...
            $uploadfile = $dir_gambar . $filename;
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['u']['tmp_name'], $uploadfile)) {            
                        mysql_query("UPDATE kendaraan SET jenis_kendaraan         = '$_POST[a]',
                                                                 merk                   = '$_POST[b]',
                                                                 type                   = '$_POST[c]',
