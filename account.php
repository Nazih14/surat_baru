<?php 
if ($_GET[aksi]==''){ 
    $e = mysql_fetch_array(mysql_query("SELECT * FROM user where id_user='$_SESSION[login]'"));
    ...
    $ee = mysql_fetch_array(mysql_query("SELECT * FROM user where id_user='$_SESSION[login]'"));
?>
