...
?>
     ...
     <div class="col-md-4 col-md-offset-4 text-center">
        ...
        <div>
            ...
            <?php }else{ ?>
            	<p>Selamat Datang di Aplikasi Pengarsipan Surat menyurat atau Penyimpanan Data Surat <br> Develop by The Team</p>
            ...
            <p class="m-t"> <small>copy; Pengarsipan Surat Menyurat 2017, Develop By The Team</small> </p>
        </div>
    </div>
...
<?php }else{ ?>
     <div class="col-md-4 col-md-offset-4 text-center">
        ...
        <div>
            <p>Selamat Datang di Aplikasi Surat menyurat atau Penyimpanan Data Surat <br> Develop by The Team</p>
