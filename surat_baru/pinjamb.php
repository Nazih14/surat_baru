 <?php 
    if ($_GET[aksi]==''){
?>
        <h4 style='padding-top:15px'>Semua Data Surat Peminjaman</h4>
            <!-- Basic Data Tables Example -->
            <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <?php if ($_SESSION[level]=='user_admin'){ ?>
                        <a class='btn btn-primary' href='index.php?page=pinjamb&aksi=tambah'><i class='fa fa-plus'></i> Tambah Surat Peminjaman</a>
                        <a class='btn btn-info' target='BLANK' href='pinjamb-print.php'><i class='fa fa-print'></i> Print Surat Peminjaman</a>
                        <a class='btn btn-success' href='pinjamb-excel.php'><i class='fa fa-file'></i> Export ke Excel</a>
                ...
                <div class="panel-body">
                 <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    <tbody>
                    <?php 
                        $outbox = mysql_query("SELECT * FROM pinjam_b ORDER BY id_pinjam ASC");
                        $no = 1;
                            ...
                            echo "<tr class='gradeX'>
                                    ...
                                    <td>$i[unit_kerja]</td>";
                                        if ($_SESSION[level]=='user_admin'){ 
                                            echo "<td style='width:170px' class='text-right'><a class='btn' href='index.php?page=pinjamb&aksi=detail&id=$i[id_pinjam]' title='Lihat Detail Surat ini'><i class='fa fa-folder-open'></i></a>
                                                  <a class='btn' target='BLANK' href='pinjamb-print-satu.php?id=$i[id_pinjam]' title='Print Surat ini'><i class='fa fa-print'></i></a>
                                                  <a class='btn' href='index.php?page=pinjamb&aksi=edit&id=$i[id_pinjam]' title='Edit Data Surat ini'><i class='fa fa-pencil-square-o'></i></a>
                                                  <a class='btn' href='index.php?page=pinjamb&aksi=hapus&id=$i[id_pinjam]' title='Hapus Surat ini' onclick=\"return confirm('Apakah anda Yakin Data ini Dihapus?')\"><i class='fa fa-trash-o'></i></a>";
                                        }elseif ($_SESSION[level]=='user_input'){ 
                                            echo "<td style='width:90px' class='text-right'><a class='btn' href='index.php?page=pinjamb&aksi=detail&id=$i[id_pinjam]' title='Lihat Detail Surat ini'><i class='fa fa-folder-open'></i></a>
                                                  <a class='btn' href='index.php?page=pinjamb&aksi=edit&id=$i[id_pinjam]' title='Edit Data Surat ini'><i class='fa fa-pencil-square-o'></i></a>";
                                        }else{
                                            echo "<td style='width:50px' class='text-right'><a class='btn' href='index.php?page=pinjamb&aksi=detail&id=$i[id_pinjam]' title='Lihat Detail Surat ini'><i class='fa fa-folder-open'></i></a>";
                                        }
                                    echo "</td>
                                 </tr>";
                            $no++;
...
<?php 
    ...
    mysql_query("DELETE FROM pinjam_b where id_pinjam='$_GET[id]'");
    echo "<script>window.alert('Data Surat Keluar Berhasil Di Hapus.');
                                window.location='pinjamb'</script>";
            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['g']['tmp_name'], $uploadfile)) {            
                         mysql_query("INSERT INTO pinjam_b (no_surat, 
															tanggal_surat,
															tujuan_surat, 
															isi_ringkas, 
															lokasi_arsip, 
                        ...
                        echo "<script>window.alert('Gagal Menambahkan Data Surat Keluar.');
                                window.location='index.php?page=pinjamb&aksi=tambah'</script>";
                    }
                }else{
                       mysql_query("INSERT INTO pinjam_b (no_surat, tanggal_surat, tujuan_surat, isi_ringkas, lokasi_arsip, nama_tanda_tangan, waktu_eksekusi, id_user, unit_kerja)           
...
?>
            ...
            <div class="col-md-12">
            <div class="panel panel-default">
            <div class="panel-heading"><strong>Tambahkan Data Surat Peminjaman</strong></div>
                <div class="panel-body">
...
<?php    
    ...
    $e = mysql_fetch_array(mysql_query("SELECT * FROM pinjam_b where id_pinjam='$_GET[id]'"));
    if (isset($_POST[update])){
            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['g']['tmp_name'], $uploadfile)) {            
                         mysql_query("UPDATE pinjam_b SET no_surat		= '$_POST[a]',
                         									  tanggal_surat		= '$_POST[b]',
                         									  tujuan_surat 		= '$_POST[c]',
                         									  isi_ringkas		= '$_POST[d]',
                         									  lokasi_arsip		= '$_POST[e]',
                         									  nama_tanda_tangan	= '$_POST[f]',
                         									  file_surat		= '$filename' where id_pinjam='$_GET[id]'");
                       ...
                       mysql_query("UPDATE outbox_g SET no_surat      = '$_POST[a]',
                                                              tanggal_surat     = '$_POST[b]',
                                                              tujuan_surat      = '$_POST[c]',
                                                              isi_ringkas       = '$_POST[d]',
                                                              lokasi_arsip      = '$_POST[e]',
                                                              nama_tanda_tangan = '$_POST[f]' where id_pinjam='$_GET[id]'");
...
?>
            ...
            <div class="col-md-12">
            <div class="panel panel-default">
            <div class="panel-heading"><strong>Edit Data Surat Pinjaman</strong></div>
                <div class="panel-body">
                    <form action='' class="form-horizontal" method="POST" data-validate="parsley" enctype='multipart/form-data'>      
                ...
                <div class='panel-body'>
                    <form action='' class='form-horizontal' data-validate='parsley' enctype='multipart/form-data'>
                        ...
                        <div class='form-group'>
                            ...
                            <div style='border-bottom:1px solid #e3e3e3' class='col-lg-9'>
                                 <a href='download_pinjam.php?file=$in[file_surat]'>Download File Surat</a>
                            </div>
                        </div>
                    </form>
                </div>
