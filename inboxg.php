            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    <tbody>
                    <?php 
                        $inbox = mysql_query("SELECT a.* FROM inbox_g a ORDER BY a.id_inbox ASC");
                        $no = 1;
            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['h']['tmp_name'], $uploadfile)) {            
                        mysql_query("INSERT INTO inbox_g (no_surat, tanggal_surat, tanggal_masuk_agenda, pengirim, lampiran, nama_penerima, id_perihal, file_surat, id_user, unit_kerja)           
                        ...
                        mysql_query("INSERT INTO inbox_g (no_surat, tanggal_surat, tanggal_masuk_agenda, pengirim, lampiran, nama_penerima, id_perihal, id_user, unit_kerja)           
...
<?php 
	...
	$e = mysql_fetch_array(mysql_query("SELECT * FROM inbox_g where id_inbox='$_GET[id]'"));
    ...
    if (isset($_POST[update])){
            ...
            $uploadfile = $dir_gambar . $filename;
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['h']['tmp_name'], $uploadfile)) {            
                        mysql_query("UPDATE inbox_g SET no_surat		        = '$_POST[a]',
...
<?php            
	...
	$in = mysql_fetch_array(mysql_query("SELECT * FROM inbox_g where id_inbox='$_GET[id]'"));
