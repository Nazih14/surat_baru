...
?>
     ...
     <div class="col-md-4 col-md-offset-4 text-center">
        ...
        <div>
            ...
            <?php }else{ ?>
            	<p>Selamat Datang di Aplikasi Surat menyurat atau Penyimpanan Data Surat <br> Develop by THE TEAM - - http://pos.projek-online.net/</p>
            ...
            <p class="m-t"> <small>&copy; surat 2017, Develop by THE TEAM</small> </p>
        </div>
    </div>
...
<?php }else{ ?>
     <div class="col-md-4 col-md-offset-4 text-center">
        ...
        <div>
            <p>Selamat Datang di Aplikasi Surat menyurat atau Penyimpanan Data Surat <br> Develop Develop by THE TEAM -http://pos.projek-online.net/</p>
