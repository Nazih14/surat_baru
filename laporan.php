            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    <tbody>
                    <?php 
                        $outbox = mysql_query("SELECT * FROM laporan ORDER BY id_laporan ASC");
                        $no = 1;
            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['g']['tmp_name'], $uploadfile)) {            
                         mysql_query("INSERT INTO laporan (pengirim, tanggal_surat, masuk_agenda, no_surat, id_perihal, disposisi, upload_file, lokasi_arsip, waktu_eksekusi, id_user)           
                       ...
                       mysql_query("INSERT INTO laporan (pengirim, tanggal_surat, masuk_agenda, no_surat, id_perihal, disposisi, lokasi_arsip, waktu_eksekusi, id_user)           
...
<?php    
    ...
    $e = mysql_fetch_array(mysql_query("SELECT * FROM laporan where id_laporan='$_GET[id]'"));
    if (isset($_POST[update])){
            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['g']['tmp_name'], $uploadfile)) {            
                         mysql_query("UPDATE laporan SET pengirim			= '$_POST[a]',
