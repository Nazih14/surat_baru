            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    <tbody>
                    <?php 
                        $outbox = mysql_query("SELECT * FROM outbox_g ORDER BY id_outbox ASC");
                        $no = 1;
...
<?php 
    ...
    mysql_query("DELETE FROM outbox_g where id_outbox='$_GET[id]'");
            ...
            $tanggaleks = date("Y-m-d H:i:s");
                if ($filename != ''){
                    if (move_uploaded_file($_FILES['g']['tmp_name'], $uploadfile)) {            
                         mysql_query("INSERT INTO outbox_g (no_surat, tanggal_surat, tujuan_surat, isi_ringkas, lokasi_arsip, nama_tanda_tangan, nama_penerima, file_surat, waktu_eksekusi, id_user, unit_kerja)           
                       ...
                       mysql_query("INSERT INTO outbox_g (no_surat, tanggal_surat, tujuan_surat, isi_ringkas, lokasi_arsip, nama_tanda_tangan, nama_penerima, waktu_eksekusi, id_user, unit_kerja)           
...
<?php    
    ...
    $e = mysql_fetch_array(mysql_query("SELECT * FROM outbox_g where id_outbox='$_GET[id]'"));
...
<?php     
    ...
    $in = mysql_fetch_array(mysql_query("SELECT * FROM outbox_g where id_outbox='$_GET[id]'"));
